...
template <> constexpr const char *c2py::tp_name<triqs::mesh::imfreq>     = "MeshImFreq";
template <> constexpr const char *c2py::tp_name<triqs::mesh::dlr_imfreq> = "MeshDLRImFreq";
template <> constexpr const char *c2py::tp_name<triqs::mesh::imtime>     = "MeshImTime";
template <> constexpr const char *c2py::tp_name<triqs::mesh::dlr_imtime> = "MeshDLRImTime";
template <> constexpr const char *c2py::tp_name<triqs::mesh::dlr>        = "MeshDLR";
template <> constexpr const char *c2py::tp_name<triqs::mesh::legendre>   = "MeshLegendre";
template <> constexpr const char *c2py::tp_name<triqs::mesh::refreq>     = "MeshReFreq";
template <> constexpr const char *c2py::tp_name<triqs::mesh::retime>     = "MeshReTime";
template <> constexpr const char *c2py::tp_name<triqs::mesh::brzone>     = "MeshBrZone";
template <> constexpr const char *c2py::tp_name<triqs::mesh::cyclat>     = "MeshCycLat";
#endif
